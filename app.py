...
st.write("---")
st.write("- 🛡️ BSc Data Science | Kes Shroff College | Mumbai, Maharashtra")    
st.write("- - "+"2020 - 2023")
st.write('\n')
st.write("- 🛡️ HSC | Swami Vivekanand International School and Jr College | Mumbai, Maharashtra")
st.write("- - "+"2018 - 2020")
st.write('\n')
st.write("- 🛡️ SSC | Indian Education Society | Mumbai, Maharashtra")
st.write("- - "+"2007 - 2018")
...
st.write("🔰[Air Canvas - Developed an Air Canvas project using OpenCV and Mediapipe, enabling users to create art through hand gestures, showcasing a fusion of computer vision and machine learning skills.](https://github.com/shreearn/Air-Canvas)")
st.write("🔰[Power-BI & Tableau Dashboard - Bank Analytics.](https://github.com/shreearn/Bank-Analytics-Power-BI-Tableau-Dashboard)")
