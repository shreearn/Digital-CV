...
st.write("🎖️[Completed Data Analytics and Visualization Job Simulation virtual internship (2023)](https://drive.google.com/file/d/1XMh2sg-1W2QuhctVJAaHQy9FIChU0Lmq/view?usp=drive_link)")
#languages known
st.write('\n')
st.write('\n')
st.write('\n')
